...
from study.views.capsule_view import capsule, ListCreateView, DetailView, CapsuleAnswerAPIView
...
urlpatterns = [
    ...
    path('segitiga/', segitiga, name='segitiga'), path('capsule/<int:pk>/answer/', CapsuleAnswerAPIView.as_view()),
